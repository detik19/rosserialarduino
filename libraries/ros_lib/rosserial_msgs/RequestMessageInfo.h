...
static const char REQUESTMESSAGEINFO[] = "rosserial_msgs/RequestMessageInfo";
  ...
  class RequestMessageInfoResponse : public ros::Msg
  {
    ...
    {
      int offset = 0;
      uint32_t * length_md5 = (uint32_t *)(outbuffer + offset);
      *length_md5 = strlen( (const char*) this->md5);
      offset += 4;
      memcpy(outbuffer + offset, this->md5, *length_md5);
      offset += *length_md5;
      uint32_t * length_definition = (uint32_t *)(outbuffer + offset);
      *length_definition = strlen( (const char*) this->definition);
      offset += 4;
    ...
    {
      int offset = 0;
      uint32_t length_md5 = *(uint32_t *)(inbuffer + offset);
      offset += 4;
      ...
      offset += length_md5;
      uint32_t length_definition = *(uint32_t *)(inbuffer + offset);
      offset += 4;
